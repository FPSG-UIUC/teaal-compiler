...
def test_emit_pos_coord():
    ...
    spacetime = SpaceTime(yaml, Partitioning({}, ["M"]), "Z")
...
def test_get_offset():
    ...
    spacetime = SpaceTime(yaml, Partitioning(parts, ["M", "N", "K"]), "Z")
...
def test_get_slip_false():
    yaml = create_yaml(["N", "M"], ["K"])
    spacetime = SpaceTime(yaml, Partitioning({}, ["M", "N", "K"]), "Z")
...
def test_eq():
    yaml = create_yaml(["M"], ["K", "N"])
    spacetime1 = SpaceTime(yaml, Partitioning({}, ["M", "N", "K"]), "Z")
    spacetime2 = SpaceTime(yaml, Partitioning({}, ["M", "N", "K"]), "Z")
...
def test_neq_space():
    ...
    spacetime1 = SpaceTime(yaml1, Partitioning({}, ["M", "N", "K"]), "Z")

    yaml2 = create_yaml([], ["K", "M", "N"])
    spacetime2 = SpaceTime(yaml2, Partitioning({}, ["M", "N", "K"]), "Z")
