...
def test_graph_static_parts():
    ...
    corr.add_edge(OtherNode("Output"), PartNode("Z", ('N',)))
    corr.add_edge(OtherNode("Body"), OtherNode("Footer"))
    corr.add_edge(PartNode("Z", ('N',)), OtherNode("Graphics"))
    corr.add_edge(PartNode("Z", ('N',)), SRNode("Z", ['M', 'N1', 'N0']))
...
def test_graph_dyn_parts():
    ...
    corr.add_edge(LoopNode("M"), LoopNode("N1"))
    corr.add_edge(LoopNode("M"), FromFiberNode("Z", "N"))
    corr.add_edge(FromFiberNode("Z", "N"), PartNode("Z", ('N',)))
    ...
    corr.add_edge(OtherNode("Body"), OtherNode("Footer"))
    corr.add_edge(OtherNode("Output"), PartNode("Z", ('N',)))
    corr.add_edge(PartNode("Z", ('N',)), SRNode("Z", ['N1', 'N0']))
    corr.add_edge(SRNode("Z", ['M', 'N']), LoopNode("M"))
    corr.add_edge(SRNode("Z", ['N1', 'N0']), LoopNode("N1"))
    ...
    corr.add_edge(SRNode("B", ['N1', 'K1I', 'N0']), PartNode("Z", ('N',)))
